...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      modeManual: "手动批准",
      modeAuto: "自动",
      modeHint: "禁用=全部拒绝 | 只读=仅截图/读光标/等待 | 手动批准=发送 /computer 批准 后可用（幂等，/computer 撤销 取消）| 自动=LLM自由调用所有工具",
    ...
    var en = {
      ...
      modeAuto: "Automatic",
      modeHint: "Disabled=refuse all | Read-only=screenshot/cursor/wait only | Manual approval=send /computer to unlock (idempotent; /computer 撤销 revokes) | Automatic=LLM freely calls all tools",
